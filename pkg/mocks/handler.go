...
// Apply provides a mock function with given fields: application, obj, secret, logger
func (_m *Handler) Apply(application *aiven_nais_io_v1.AivenApplication, obj client.Object, secret *v1.Secret, logger *logrus.Entry) error {
	ret := _m.Called(application, obj, secret, logger)

	var r0 error
	if rf, ok := ret.Get(0).(func(*aiven_nais_io_v1.AivenApplication, client.Object, *v1.Secret, *logrus.Entry) error); ok {
		r0 = rf(application, obj, secret, logger)
	} else {
		r0 = ret.Error(0)
	}
